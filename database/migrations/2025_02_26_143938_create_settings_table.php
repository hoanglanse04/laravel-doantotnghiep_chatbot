...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('setting_fields', function (Blueprint $table) {
            ...
            $table->enum('type', ['text', 'textarea', 'select', 'multi-select', 'radio', 'checkbox', 'image', 'file', 'number', 'email', 'password', 'date-range'])->default('text')->comment('Loại dữ liệu của trường');
