...
@section('content')
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between text-xl">
            ...
            <a class="text-sm text-white font-medium bg-[#56a661] hover:shadow-md transition px-6 py-2.5 rounded-full cursor-pointer" href="{{ route('admin.customer.edit', ['page' => $data->id]) }}">
                Chỉnh sửa
            </a>
        </div>
        ...
        <ul class="grid grid-cols-5 gap-6 ml-4">
            ...
            <li>
                <div class="uppercase font-semibold text-xs text-gray-600">Tên trang</div>
            ...
            <li>
                <div class="uppercase font-semibold text-xs text-gray-600">Giao diện</div>
                <span class="font-semibold mt-1 line-clamp-2">{{ $data->template ?: 'N/A' }}</span>
            </li>
        </ul>
