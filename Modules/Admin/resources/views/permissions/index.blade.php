@php
    ...
    $headers = ['Thông tin', 'Mô tả ngắn', 'Trạng thái', 'Tác giả', 'Ngày tạo', 'Hành động'];
@endphp
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td>
                        <x-admin::form.dropdown
                            ...
                            classItem="block py-2 px-4 text-xs hover:bg-gray-100"
                            :items="[
                                ['label' => 'Chỉnh sửa', 'href' => route('admin.permissions.edit', $row->id)],
                                ['label' => 'Xóa', 'onclick' => 'deleteProduct('.$row->id.')', 'class' => 'text-red-600']
                            ]"
                        >
                            <x-admin::form.button
                                type="button"
