...
@section('content')
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between text-xl">
            ...
            <a class="text-sm text-white font-medium bg-[#56a661] hover:shadow-md transition px-6 py-2.5 rounded-full cursor-pointer" href="{{ route('admin.contact.edit', ['page' => $data->id]) }}">
                Chỉnh sửa
            </a>
        </div>
