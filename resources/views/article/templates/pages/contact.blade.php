...
@section('main')
    <main>
        ...
        <section class="md:py-20 py-10 bg-no-repeat bg-cover"
            style="background-image: url('assets/frontend/img/gradient-background.png')">
            <div class="max-w-7xl mx-auto px-4 grid grid-cols-12 md:gap-4 gap-6">
                <div class="md:col-span-6 col-span-12 transform space-y-6 ">
                    <div class="inline-flex items-start py-2 px-3 space-x-3 bg-white rounded-lg shadow-5xl">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="12" height="12">
                            <path
                                d="M25 11C17.28125 11 11 17.28125 11 25C11 32.71875 17.28125 39 25 39C32.71875 39 39 32.71875 39 25C39 17.28125 32.71875 11 25 11Z"
                                fill="#4277bd" />
                        </svg>
                    ...
                    <p class="font-semibold text-sm leading-6 text-[#616f92] max-w-[483px]">Hãy gọi cho chúng tôi hoặc ghé
                        thăm bất cứ lúc nào, chúng tôi cố gắng trả lời mọi thắc mắc trong vòng 24 giờ vào các ngày làm việc.
                        Chúng tôi sẽ vui lòng trả lời các câu hỏi của bạn.</p>
                    <div class="space-y-3">
                        <div class="flex items-center space-x-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-current text-gray-600" viewBox="0 0 32 32"
                                width="24" height="24">
                                <path
                                    d="M3 7L3 7.0332031L16 14.833984L29 7.0332031L29 7L3 7 z M 3 9.3652344L3 25L29 25L29 9.3652344L16 17.166016L3 9.3652344 z" />
                            </svg>
                            <p class="font-semibold leading-6 text-sm text-[#35475b]">{{ setting('contact_email') }}</p>
                        </div>
                        <div class="flex items-center space-x-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-current text-gray-600" viewBox="0 0 26 26"
                                width="22" height="22">
                                <path
                        ...
                        <div class="flex items-center space-x-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-current text-gray-600" viewBox="0 0 50 50"
                                width="24" height="24">
                                <path
                ...
                <div class="bg-white rounded-2xl md:col-span-6 col-span-12 p-6 shadow-4xl space-y-6">
                    {{-- <div class="space-y-2">
                        ...
                        <p class="font-semibold text-sm leading-6 text-[#616f92]">Đội ngũ hỗ trợ của chúng tôi sẽ phản hôid
                            trong vòng 1-2 tiếng làm việc</p>
                    </div> --}}
                    {{-- <form action="{{ route('form.contact') }}" method="POST" class="space-y-4" id="recapchaform">
                        ...
                        <div class="relative mb-6">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                class="border border-gray-300 text-sm rounded-xl block w-full pt-6 pl-3 pb-2 placeholder-input"
                        ...
                        <div class="relative mb-6">
                            ...
                            <textarea name="content" value="{{ old('content') }}"
                                class="border border-gray-300 text-sm rounded-xl block w-full pt-6 pl-3 pb-2 h-36 placeholder-input"
                                placeholder="Hãy mô tả về vấn đề của bạn" required></textarea>
                        </div>
                        <button type="submit"
                            class="flex items-center justify-center cursor-pointer space-x-2 w-full rounded-lg text-sm py-3 bg-[#ef233c] transtion">
                    ...
                    {{-- Thay thế khối form bằng iframe Google Form --}}
                    <div class="bg-white rounded-2xl md:col-span-6 col-span-12 p-6 shadow-4xl space-y-6">


                        <div class="rounded-xl ring-1 ring-black/5 overflow-hidden">
                            <iframe src="{{ setting(slug: 'link_contact') }}" class="w-full min-h-[980px]"
                                loading="lazy">Đang tải…</iframe>
                        </div>

                        <p class="text-xs text-gray-500 text-end">
                            Nếu form không hiển thị, mở trực tiếp
                            <a class="text-blue-600 underline" href="{{ setting(slug: 'link_contact') }}" target="_blank"
                                rel="noopener">tại đây</a>.
                        </p>
                    </div>
